...
SECRET_KEY = '40a2@_bx)mttzpu95%tnhtlo+c(o9k_=os!4a_*4fl(8s%b$ut'
...
TEMPLATES[0]['OPTIONS']['context_processors'].append('main.context_processors.city_processor')
...
EMAIL_HOST_USER = 'antonfewwt@gmail.com'
EMAIL_HOST_PASSWORD = '32nMgfw2'
EMAIL_PORT = 587
